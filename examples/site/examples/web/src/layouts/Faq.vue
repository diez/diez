      ...
      <section class="section-split">
        ...
        <div class="two-thirds answer">
          ...
          <ul>
            ...
            <li>A <strong>compiler layer</strong> that is capable of parsing user-defined and <router-link to="/glossary#prefabs">prefab</router-link> components and emitting native SDKs according to a flexible set of rules. With the Diez compiler API, you can define entirely new <router-link to="/glossary#targets">target</router-link> SDK languages and platforms, extend existing language/platform implementations, and, if needed, even provide custom <router-link to="/glossary#bindings">native bindings</router-link> for special components.</li>
          </ul>
        </div>
        <div class="one-third question">
        ...
        <div class="two-thirds answer">
          <p>Diez is open source — check out the <a href="https://github.com/diez/diez/blob/master/CONTRIBUTING.md">contributing guidelines</a>!</p>
        </div>
        <div class="one-third question">
          <h3>Do I have to use the components provided by Diez?</h3>
        </div>
        <div class="two-thirds answer">
          <p>No. You can use as many or as few of them as you want. You can design your own — Diez is designed for extensibility. Our current beta includes a number of <router-link to="/glossary#prefabs">prefab</router-link> components implementing some <router-link to="/glossary#tokens">design tokens</router-link> we've observed in design systems. We'll certainly be adding more, and you can too.</p>
        </div>
        <div class="one-third question" id="where-it-lives">
        ...
        <div class="two-thirds answer">
          <p><router-link to="/glossary#hot-mode">Hot mode</router-link> is a completely optional feature — you can use Diez-generated SDKs as a single source of truth for your design system without touching it at all.</p>
        </div>
        <div class="one-third question">
        ...
        <div class="two-thirds answer">
          <p>Diez is a soon-to-be open source project designed and built by <a href="http://www.haikuforteams.com/">haikuforteams.com</a>.</p>
        </div>
        <div class="one-third question">
        ...
        <div class="two-thirds answer">
          ...
          <p>Our current roadmap will be on GitHub very soon.</p>
        </div>
      </section>
    </div>
    <Footer/>
