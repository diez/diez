...
; "npm config ls -l" to show all defaults.
  ...
  test('returns expected values', async () => {
    expect(await canUseNpm('/Users/jiraffe/projects/haiku/diez/src/compiler/compiler-core')).toBe(false);
    expect(await canUseNpm('/Users/jiggs/projects/haiku/diez/src/compiler/compiler-core')).toBe(true);
  });
