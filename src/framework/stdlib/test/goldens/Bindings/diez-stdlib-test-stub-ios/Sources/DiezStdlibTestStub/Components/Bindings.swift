...
public final class Bindings: NSObject, RootComponent {
    ...
    convenience public override init() {
        self.init(
            ...
            typograph: Typograph(font: Font(file: File(src: "assets/SomeFont.ttf", type: "font"), name: "SomeFont"), fontSize: 50, color: Color(h: 0.16666666666666666, s: 1, l: 0.5, a: 1), iosTextStyle: "body", shouldScale: false),
